...
if (navigator.standlone) {
	// App is installed


	// Quick introduction

	// Your email to keep track of your progress

	// Share progress on Facebook

	if (true /* Known user */) {
		Resolver("essential::activateArea::")("game");

	} else {
		Resolver("essential::activateArea::")("please register");

	}

}

//TODO http://davidwalsh.name/demo/fullscreen.php


Resolver("page").on("change","pages",function(ev) {
	if (ev.symbol != "pages") {
		debugger;
	}
