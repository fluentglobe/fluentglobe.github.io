...
function enhance_book(el,role,config) {
	...
	var reader = require('../../book-reader/index.js');
...
},{"../../book-reader/index.js":1,"./form.js":2,"./impl.js":3,"./router.js":5,"./slider.js":6}],5:[function(require,module,exports){
// router.intercept(["/sp/servlet/logout","/ws/servlet/logout"], function() {
//    .... will do the logout
// })

!function() {
if (!window.Resolver) return; // no essential support
