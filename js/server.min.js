...
this.dmp.diff_fromDelta(a,k.v)),k=this.dmp.patch_make(a,this.dmp.diff_fromDelta(a,c.v)),k=this.dmp.patch_apply(k,a)[0],g=this.dmp.patch_apply(g,k)[0],g!==k&&(g=this.dmp.diff_main(k,g),2<g.length&&this.dmp.diff_cleanupEfficiency(g),0<g.length&&(d[s]={o:"d",v:this.dmp.diff_toDelta(g)}))),d};a.prototype.patch_apply_with_offsets=function(a,b,e){var g,c,d,s,r,n,p,u,t,q,m,v,w,x,B,C,y;if(0===a.length)return b;a=this.dmp.patch_deepCopy(a);q=this.dmp.patch_addPadding(a);b=q+b+q;this.dmp.patch_splitMax(a);
v=w=d=0;for(B=a.length;0<=B?w<B:w>B;v=0<=B?++w:--w){r=a[v].start2+d;p=this.dmp.diff_text1(a[v].diffs);s=-1;if(p.length>this.dmp.Match_MaxBits){if(m=this.dmp.match_main(b,p.substring(0,this.dmp.Match_MaxBits),r),-1!==m&&(s=this.dmp.match_main(b,p.substring(p.length-this.dmp.Match_MaxBits),r+p.length-this.dmp.Match_MaxBits),-1===s||m>=s))m=-1}else m=this.dmp.match_main(b,p,r);if(-1===m)d-=a[v].length2-a[v].length1;else if(d=m-r,s=-1===s?b.substring(m,m+p.length):b.substring(m,s+this.dmp.Match_MaxBits),
s=this.dmp.diff_main(p,s,!1),!(p.length>this.dmp.Match_MaxBits&&this.dmp.diff_levenshtein(s)/p.length>this.dmp.Patch_DeleteThreshold))for(n=r=p=0,C=a[v].diffs.length;0<=C?r<C:r>C;n=0<=C?++r:--r){t=a[v].diffs[n];0!==t[0]&&(u=this.dmp.diff_xIndex(s,p));if(1===t[0])for(b=b.substring(0,m+u)+t[1]+b.substring(m+u),n=g=0,c=e.length;0<=c?g<c:g>c;n=0<=c?++g:--g)e[n]+q.length>m+u&&(e[n]+=t[1].length);else if(-1===t[0])for(c=m+u,g=m+this.dmp.diff_xIndex(s,p+t[1].length),b=b.substring(0,c)+b.substring(g),n=x=
...
diff_match_patch.prototype.diff_bisect_=function(a,c,b){for(var d=a.length,h=c.length,f=Math.ceil((d+h)/2),e=2*f,g=Array(e),l=Array(e),k=0;k<e;k++)g[k]=-1,l[k]=-1;g[f+1]=0;l[f+1]=0;for(var k=d-h,s=0!=k%2,r=0,n=0,p=0,u=0,t=0;t<f&&!((new Date).getTime()>b);t++){for(var q=-t+r;q<=t-n;q+=2){var m=f+q,v;v=q==-t||q!=t&&g[m-1]<g[m+1]?g[m+1]:g[m-1]+1;for(var w=v-q;v<d&&w<h&&a.charAt(v)==c.charAt(w);)v++,w++;g[m]=v;if(v>d)n+=2;else if(w>h)r+=2;else if(s&&(m=f+k-q,0<=m&&m<e&&-1!=l[m])){var x=d-l[m];if(v>=x)return this.diff_bisectSplit_(a,
c,v,w,b)}}for(q=-t+p;q<=t-u;q+=2){m=f+q;x=q==-t||q!=t&&l[m-1]<l[m+1]?l[m+1]:l[m-1]+1;for(v=x-q;x<d&&v<h&&a.charAt(d-x-1)==c.charAt(h-v-1);)x++,v++;l[m]=x;if(x>d)u+=2;else if(v>h)p+=2;else if(!s&&(m=f+k-q,0<=m&&m<e&&-1!=g[m]&&(v=g[m],w=f+v-m,x=d-x,v>=x)))return this.diff_bisectSplit_(a,c,v,w,b)}}return[[DIFF_DELETE,a],[DIFF_INSERT,c]]};
...
(this.first=!0,a="limit"in this.options?"i:1:::"+this.options.limit:"i:1:::40",this.irequest_time=this.now(),this.index_request=!0,this.notify_index={},b={app_id:this.options.app_id,token:this.options.token,name:this.name,clientid:this.clientid,build:this.s.bversion},this.initialized||(b.cmd=a),this.send("init:"+JSON.stringify(b)))};a.prototype.on_data=function(a){var b,c,d;if("auth:"===a.substr(0,5))if(b=a.substr(5),"expired"===b)this.started=!1,null!=this.cb_e&&this.cb_e("auth");else{if(this.username=
b,this.authorized=!0,this.initialized)return this.start()}else{if("cv:?"===a.substr(0,4))return setTimeout(function(a){return function(){return a._refresh_store()}}(this));if("c:"===a.substr(0,2))return b=JSON.parse(a.substr(2)),"0"!==this.data.last_cv||0!==b.length||this.cv_check||(this.cv_check=!0,this._refresh_store()),this.on_changes(b);if("i:"===a.substr(0,2))return this.on_index_page(JSON.parse(a.substr(2)));if("e:"===a.substr(0,2)){d=a.indexOf("\n");c=a.substr(2,d-2);b=c.substr(c.lastIndexOf(".")+
1);c=c.substr(0,c.lastIndexOf("."));a=a.substr(d+1);if("?"===a)return this.on_entity_version(null,c,b);a=JSON.parse(a);return this.on_entity_version(a.data,c,b)}return!1}};a.prototype.send=function(a){return this.s.send(""+this.chan+":"+a)};a.prototype._refresh_store=function(){this.send("limit"in this.options?"i:1:::"+this.options.limit:"i:1:::40");this.irequest_time=this.now();this.index_request=!0};a.prototype.on_index_page=function(a){var b,c,d,f,h,n;this.now();c=0;n=a.index;f=0;for(h=n.length;f<
h;f++)b=n[f],this.notify_index[b.id]=!1,c++,setTimeout(function(a){return function(e){return function(){return a.on_entity_version(e.d,e.id,e.v)}}}(this)(b));if(!("mark"in a)||"limit"in this.options){if(this.index_request=!1,"current"in a?(this.data.last_cv=a.current,this._save_meta()):this.data.last_cv=0,0===c)return this._index_loaded()}else return this.index_request=!0,a=a.mark,d=function(a){return function(e){a.send("i:1:"+e+"::100");return a.irequest_time=a.now()}}(this),setTimeout(function(a){return function(a){return function(){return d(a)}}}(this)(a),
this.options.page_delay)};a.prototype.on_index_error=function(){return!1};a.prototype.load_versions=function(a,b){var c,d,f,h,n;if(!(a in this.data.store))return!1;c=Math.max(this.data.store[a].version-(b+1),1);n=[];d=f=c;for(h=this.data.store[a].version-1;c<=h?f<=h:f>=h;d=c<=h?++f:--f)n.push(this.send("e:"+a+"."+d));return n};a.prototype.get_version=function(a,b){return this.send("e:"+(""+a+"."+b))};a.prototype.on_entity_version=function(a,b,c){var f,h,r;f=null!=a?this.jd.deepCopy(a):null;r=!1===
this.initialized&&null!=this.cb_ni?this.cb_ni:this.cb_n;if(b in this.data.store&&"last"in this.data.store[b]&&this.jd.entries(this.data.store[b].last))return f=this.jd.deepCopy(this.data.store[b].last),r(b,f,null),this.notify_index[b]=!0,this._check_update(b);if(b in this.data.store&&c<this.data.store[b].version)return this.cb_nv(b,f,c);b in this.data.store||(this.data.store[b]={});this.data.store[b].id=b;this.data.store[b].object=a;this.data.store[b].version=parseInt(c);r(b,f,c);this.notify_index[b]=
!0;a=0;b=this.notify_index;for(h in b)d.call(b,h)&&!1===this.notify_index[h]&&a++;if(0===a&&!1===this.index_request)return this._index_loaded()};a.prototype._index_loaded=function(){!1===this.initialized&&this.cb_r();this.initialized=!0;return this.retrieve_changes()};a.prototype._notify_client=function(a,b,c,d,f){var h,n,p,u,t;if(null==this.cb_l)this.cb_n(a,b,f);else return h=this.cb_l(a),n=null,t=[],"array"===this.jd.typeOf(h)&&(p=h[2],u=h[1],h=h[0],n=this.s._captureCursor(p))&&(t[0]=n.startOffset,
"endOffset"in n&&(t[1]=n.endOffset)),null!=h&&null!=c?(h=this.jd.object_diff(c,h),0===this.jd.entries(h)?b=c:d=this.jd.transform_object_diff(h,d,c),n?(b=this.jd.apply_object_diff_with_offsets(b,d,u,t),null!=p&&"value"in p&&(p.value=b[u]),n.startOffset=t[0],1<t.length&&(n.endOffset=t[1],n.startOffset>=n.endOffset&&(n.collapsed=!0)),this.s._restoreCursor(p,n)):b=this.jd.apply_object_diff(b,d),this.cb_n(a,b,f)):b?this.cb_n(a,b,f):this.cb_n(a,null,null)};a.prototype._check_update=function(a){var b,c,
d,f,h;if(!(a in this.data.store))return!1;c=this.data.store[a];if(c.change){a=!1;h=this.data.send_queue;d=0;for(f=h.length;d<f;d++)b=h[d],b.id===c.change.id&&b.ccid===c.change.ccid&&(a=!0);return a?!1:(this._queue_change(c.change),!0)}if(null!=c.check)return!1;if("last"in c&&this.jd.equals(c.object,c.last))return delete c.last,this._remove_entity(a),!1;b=this._make_change(a);null!=b?(c.change=b,this._queue_change(b)):this._remove_entity(a);return!0};a.prototype.update=function(a,b){var c,d,f,h,n;
if(1===arguments.length)if(null!=this.cb_l)b=this.cb_l(a),"array"===this.jd.typeOf(b)&&(b=b[0]);else throw Error("missing 'local' callback");if(null==a&&null==b)return!1;if(null!=a){if(0===a.length||-1!==a.indexOf("/"))return!1}else a=this.uuid();a in this.data.store||(this.data.store[a]={id:a,object:{},version:null,change:null,check:null});d=this.data.store[a];d.last=this.jd.deepCopy(b);d.modified=this.s._time();this._save_entity(a);n=this.data.send_queue;f=0;for(h=n.length;f<h;f++)if(c=n[f],String(a)===
c.id)return null;null!=d.check&&clearTimeout(d.check);d.check=setTimeout(function(a){return function(b,e){return function(){e.check=null;e.change=a._make_change(b);delete e.last;a._save_entity(b);return a._queue_change(e.change)}}}(this)(a,d),this.options.update_delay);return a};a.prototype._make_change=function(a){var b,c;c=this.data.store[a];b={id:String(a),ccid:this.uuid()};if(this.initialized)if(null!=this.cb_l)a=this.cb_l(a),"array"===this.jd.typeOf(a)&&(a=a[0]);else if("last"in c)a=c.last;else return null;
else if("last"in c)a=c.last;else return null;null!=c.version&&(b.sv=c.version);null===a&&null!=c.version?b.o="-":null!=a&&null!=c.object?(b.o="M","sendfull"in c?(b.d=this.jd.deepCopy(a),delete c.sendfull):(b.v=this.jd.object_diff(c.object,a),0===this.jd.entries(b.v)&&(b=null))):b=null;return b};a.prototype._queue_change=function(a){if(null!=a)return this.data.send_queue.push(a),this.send("c:"+JSON.stringify(a)),this._check_pending(),null!=this.data.send_queue_timer&&clearTimeout(this.data.send_queue_timer),
this.data.send_queue_timer=setTimeout(this._send_changes,this._send_backoff)};a.prototype._send_changes=function(){var a,b,c,d;if(0===this.data.send_queue.length)this.data.send_queue_timer=null;else{if(this.s.connected)for(d=this.data.send_queue,b=0,c=d.length;b<c;b++)a=d[b],this.send("c:"+JSON.stringify(a));this._send_backoff*=2;this._send_backoff>this._backoff_max&&(this._send_backoff=this._backoff_max);return this.data.send_queue_timer=setTimeout(this._send_changes,this._send_backoff)}};a.prototype.retrieve_changes=
function(){this.send("cv:"+this.data.last_cv)};a.prototype.on_changes=function(a){var b,c,d,f,h,n,p,u,t,q,m,v,w;c=[];u=!1;this._send_backoff=this._backoff_min;t=0;for(m=a.length;t<m;t++){b=a[t];d=b.id;f=[];w=this.data.send_queue;q=0;for(v=w.length;q<v;q++)p=w[q],b.clientid===this.clientid&&d===p.id&&(b.local=!0,f.push(p),c.push(d));p=0;for(q=f.length;p<q;p++)n=f[p],this.data.store[n.id].change=null,this._save_entity(n.id),this.data.send_queue=function(){var a,b,c,e;c=this.data.send_queue;e=[];a=0;
for(b=c.length;a<b;a++)h=c[a],h!==n&&e.push(h);return e}.call(this);0<f.length&&this._check_pending();if("error"in b)switch(b.error){case 412:d=c.indexOf(b.id);-1<d&&c.splice(d,1);break;case 409:break;case 405:b.id in this.data.store&&(this.data.store[b.id].version=null);u=!0;break;case 440:this.data.store[d].sendfull=!0;break;default:b.id in this.data.store&&(this.data.store[b.id].version=null),u=!0}else f=b.o,"-"===f?(delete this.data.store[d],this._remove_entity(d),"local"in b||this._notify_client(b.id,
null,null,null,null)):"M"===f&&(f=this.data.store[d],"sv"in b&&null!=f&&null!=f.version&&f.version===b.sv||!("sv"in b)||1===b.ev?(null==f&&(this.data.store[d]={id:d,object:{},version:null,change:null,check:null},f=this.data.store[d]),d=this.jd.deepCopy(f.object),f.object=this.jd.apply_object_diff(f.object,b.v),f.version=b.ev,f=this.jd.deepCopy(f.object),"local"in b||this._notify_client(b.id,f,d,b.v,b.ev)):null!=f&&null!=f.version&&b.ev<=f.version||(null!=f&&(this.data.store[d].version=null),u=!0)),
u||(this.data.last_cv=b.cv,this._save_meta())}if(u)setTimeout(function(a){return function(){return a._refresh_store()}}(this));else for(a=function(a){return function(b){return setTimeout(function(){return a._check_update(b)},a.options.update_delay)}}(this),u=0,t=c.length;u<t;u++)d=c[u],a(d)};a.prototype.pending=function(){var a,b,c,d,f;d=this.data.send_queue;f=[];b=0;for(c=d.length;b<c;b++)a=d[b],f.push(a.id);d=this.data.send_queue;f=[];b=0;for(c=d.length;b<c;b++)a=d[b],f.push(a.id);return f};a.prototype._check_pending=
function(){var a,b,c,d,f,h;if(null!=this.cb_np){a=this.pending();b=!0;if(this._last_pending)if(b=!1,this._last_pending.length===a.length)for(h=this._last_pending,d=0,f=h.length;d<f;d++)c=h[d],-1===a.indexOf(c)&&(b=!0);else b=!0;if(b)return this._last_pending=a,this.cb_np(a)}};return a}();c=function(){function c(a,g){var f,h,s;this.app_id=a;this.options=g;this._restoreCursor=b(this._restoreCursor,this);this._captureCursor=b(this._captureCursor,this);this._sock_message=b(this._sock_message,this);this._sock_hb_check=
b(this._sock_hb_check,this);this._sock_closed=b(this._sock_closed,this);this._sock_opened=b(this._sock_opened,this);this._sock_connect=b(this._sock_connect,this);this.synced=b(this.synced,this);this.send=b(this.send,this);this.stop=b(this.stop,this);this.start=b(this.start,this);this.on=b(this.on,this);this.bucket=b(this.bucket,this);this.bversion=2014030401;this.jd=new jsondiff;this.dmp=this.jd.dmp;this.auth_token=null;this.options=this.options||{};this.options.app_id=this.app_id;this.sock_opts=
{debug:!1};if("sockjs"in this.options)for(f in s=this.options.sockjs,s)d.call(s,f)&&(h=s[f],this.sock_opts[f]=h);"host"in this.options||(this.options.host="api.simperium.com");"port"in this.options||(this.options.port=80);"token"in this.options&&(this.auth_token=this.options.token);f=-1!==this.options.host.indexOf("simperium.com")?"https":"http";this.buckets={};this.channels=0;"update_delay"in this.options||(this.options.update_delay=0);"page_delay"in this.options||(this.options.page_delay=0);this.options.prefix=
"sock/1/"+this.app_id;this.options.port=parseInt(this.options.port);this.sock_url=80!==this.options.port&&443!==this.options.port?""+f+"://"+this.options.host+":"+this.options.port+"/"+this.options.prefix:""+f+"://"+this.options.host+"/"+this.options.prefix;this.stopped=!1;this._sock_backoff=3E3;this._sock_hb=1;this._sock_connect()}c.prototype.lowerstrip=function(a){a=a.toLowerCase();return null!=String.prototype.trim?a.trim():a.replace(/^\s+|\s+$/g,"")};c.prototype._time=function(){var a;a=new Date;
return Date.UTC(a.getUTCFullYear(),a.getUTCMonth(),a.getUTCDate(),a.getUTCHours(),a.getUTCMinutes(),a.getUTCSeconds(),a.getUTCMilliseconds())/1E3};c.prototype.supports_html5_storage=function(){try{return"localStorage"in window&&null!==window.localStorage}catch(a){return!1}};c.prototype.bucket=function(b,c){var d;b=this.lowerstrip(b);c=c||{};c.n=this.channels++;d=new a(this,b,c);return this.buckets[c.n]=d};c.prototype.on=function(a,b,c){return this.buckets[a].on(b,c)};c.prototype.start=function(){var b,
c,f;this.stopped=!1;c=this.buckets;f=[];for(b in c)d.call(c,b)&&(a=c[b],f.push(a.start()));return f};c.prototype.stop=function(){this.stopped=!0;if(null!=this.sock)return this.sock.close()};c.prototype.send=function(a){return this.sock.send(a)};c.prototype.synced=function(){var b,c;c=this.buckets;for(b in c)if(d.call(c,b)&&(a=c[b],0<a.pending().length))return!1;return!0};c.prototype._sock_connect=function(){this.authorized=this.connected=!1;this.sock=new SockJS(this.sock_url,void 0,this.sock_opts);
this.sock.onopen=this._sock_opened;this.sock.onmessage=this._sock_message;return this.sock.onclose=this._sock_closed};c.prototype._sock_opened=function(){var b,c,f;this._sock_backoff=3E3;this.connected=!0;this._sock_hb_timer=setTimeout(this._sock_hb_check,2E4);c=this.buckets;f=[];for(b in c)d.call(c,b)&&(a=c[b],a.started?f.push(a.start()):f.push(void 0));return f};c.prototype._sock_closed=function(){var b,c;this.connected=!1;c=this.buckets;for(b in c)d.call(c,b)&&(a=c[b],a.authorized=!1);this._sock_backoff=
4E3>this._sock_backoff?this._sock_backoff+1:15E3;this._sock_hb_timer&&(clearTimeout(this._sock_hb_timer),this._sock_hb_timer=null);if(!this.stopped)return setTimeout(this._sock_connect,this._sock_backoff)};c.prototype._sock_hb_check=function(){var a;a=(new Date).getTime()-this._sock_msg_time;if(!1!==this.connected)return 4E4<a?this.sock.close():15E3<a&&this.sock.send("h:"+this._sock_hb),this._sock_hb_timer=setTimeout(this._sock_hb_check,2E4)};c.prototype._sock_message=function(a){var b,c;this._sock_msg_time=
(new Date).getTime();b=a.data;c=b.indexOf(":");a=null;if(1===c&&"h"===b.charAt(0))this._sock_hb=b.substr(2);else{try{a=parseInt(b.substr(0,c)),b=b.substr(c+1)}catch(d){a=null}if(null!==a&&a in this.buckets)return this.buckets[a].on_data(b)}};c.prototype._captureCursor=function(a){};c.prototype._captureCursor=function(a){if("activeElement"in a&&!a.activeElement)return null;var b=this.dmp.Match_MaxBits/2,c=a.value,d={};if("selectionStart"in a){try{var f=a.selectionStart,h=a.selectionEnd}catch(n){return null}d.startPrefix=
c.substring(f-b,f);d.startSuffix=c.substring(f,f+b);d.startOffset=f;d.collapsed=f==h;d.collapsed||(d.endPrefix=c.substring(h-b,h),d.endSuffix=c.substring(h,h+b),d.endOffset=h)}else{for(f=a;f.parentNode;)f=f.parentNode;if(!f.selection||!f.selection.createRange)return null;c=f.selection.createRange();if(c.parentElement()!=a)return null;f=f.body.createTextRange();d.collapsed=""==c.text;f.moveToElementText(a);d.collapsed||(f.setEndPoint("EndToEnd",c),d.endPrefix=f.text,d.endOffset=d.endPrefix.length,
d.endPrefix=d.endPrefix.substring(d.endPrefix.length-b));f.setEndPoint("EndToStart",c);d.startPrefix=f.text;d.startOffset=d.startPrefix.length;d.startPrefix=d.startPrefix.substring(d.startPrefix.length-b);f.moveToElementText(a);f.setEndPoint("StartToStart",c);d.startSuffix=f.text.substring(0,b);d.collapsed||(f.setEndPoint("StartToEnd",c),d.endSuffix=f.text.substring(0,b))}"scrollTop"in a&&(d.scrollTop=a.scrollTop/a.scrollHeight,d.scrollLeft=a.scrollLeft/a.scrollWidth);return d};c.prototype._restoreCursor=
function(a,b){};c.prototype._restoreCursor=function(a,b){this.dmp.Match_Distance=1E3;this.dmp.Match_Threshold=0.9;var c=this.dmp.Match_MaxBits/2,d=a.value,f=b.startPrefix+b.startSuffix,h,n=this.dmp.match_main(d,f,b.startOffset-c);null!==n&&(h=d.substring(n,n+f.length),f=this.dmp.diff_main(f,h,!1),n+=this.dmp.diff_xIndex(f,b.startPrefix.length));var p=null;b.collapsed||(f=b.endPrefix+b.endSuffix,p=this.dmp.match_main(d,f,b.endOffset-c),null!==p&&(h=d.substring(p,p+f.length),f=this.dmp.diff_main(f,
h,!1),p+=this.dmp.diff_xIndex(f,b.endPrefix.length)));null===n&&null!==p?n=p:null===n&&null===p&&(n=b.startOffset);null===p&&(p=n);if("selectionStart"in a)a.selectionStart=n,a.selectionEnd=p;else{for(c=a;c.parentNode;)c=c.parentNode;if(!c.selection||!c.selection.createRange)return;d=a.value.substring(0,n);d=d.replace(/\r\n/g,"\n").length;c=c.body.createTextRange();c.moveToElementText(a);c.collapse(!0);c.moveStart("character",d);b.collapsed||(d=a.value.substring(n,p),n=d.replace(/\r\n/g,"\n").length,
c.moveEnd("character",n));c.select()}"scrollTop"in b&&(a.scrollTop=b.scrollTop*a.scrollHeight,a.scrollLeft=b.scrollLeft*a.scrollWidth)};return c}();window.Simperium=c;a.prototype.on=a.prototype.on;a.prototype.start=a.prototype.start;a.prototype.load_versions=a.prototype.load_versions;a.prototype.pending=a.prototype.pending;c.prototype.on=c.prototype.on;c.prototype.start=c.prototype.start;c.prototype.bucket=c.prototype.bucket;c.prototype.synced=c.prototype.synced}).call(this);
