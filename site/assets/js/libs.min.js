...
!function(){"use strict";function e(e,n){return e.module("angularMoment",[]).constant("angularMomentConfig",{preprocess:null,timezone:"",format:null}).constant("moment",n).constant("amTimeAgoConfig",{withoutSuffix:!1,serverTime:null}).directive("amTimeAgo",["$window","moment","amMoment","amTimeAgoConfig","angularMomentConfig",function(n,t,o,i,a){return function(r,u,m){function f(){var e;if(i.serverTime){var n=(new Date).getTime(),o=n-w+i.serverTime;e=t(o)}else e=t();return e}function c(){h&&(n.clearTimeout(h),h=null)}function s(e){if(u.text(e.from(f(),T)),!$){var t=Math.abs(f().diff(e,"minute")),o=3600;1>t?o=1:60>t?o=30:180>t&&(o=300),h=n.setTimeout(function(){s(e)},1e3*o)}}function l(e){z&&u.attr("datetime",e)}function d(){if(c(),p){var e=o.preprocessDate(p,M,v);s(e),l(e.toISOString())}}var p,g,h=null,v=a.format,T=i.withoutSuffix,w=(new Date).getTime(),M=a.preprocess,y=m.amTimeAgo.replace(/^::/,""),$=0===m.amTimeAgo.indexOf("::"),z="TIME"===u[0].nodeName.toUpperCase();g=r.$watch(y,function(e){return"undefined"==typeof e||null===e||""===e?(c(),void(p&&(u.text(""),l(""),p=null))):(p=e,d(),void(void 0!==e&&$&&g()))}),e.isDefined(m.amWithoutSuffix)&&r.$watch(m.amWithoutSuffix,function(e){"boolean"==typeof e?(T=e,d()):T=i.withoutSuffix}),m.$observe("amFormat",function(e){"undefined"!=typeof e&&(v=e,d())}),m.$observe("amPreprocess",function(e){M=e,d()}),r.$on("$destroy",function(){c()}),r.$on("amMoment:localeChanged",function(){d()})}}]).service("amMoment",["moment","$rootScope","$log","angularMomentConfig",function(n,t,o,i){var a=this;this.preprocessors={utc:n.utc,unix:n.unix},this.changeLocale=function(o){var i=(n.locale||n.lang)(o);return e.isDefined(o)&&(t.$broadcast("amMoment:localeChanged"),t.$broadcast("amMoment:languageChange")),i},this.changeLanguage=function(e){return o.warn("angular-moment: Usage of amMoment.changeLanguage() is deprecated. Please use changeLocale()"),a.changeLocale(e)},this.preprocessDate=function(t,a,r){return e.isUndefined(a)&&(a=i.preprocess),this.preprocessors[a]?this.preprocessors[a](t,r):(a&&o.warn("angular-moment: Ignoring unsupported value for preprocess: "+a),!isNaN(parseFloat(t))&&isFinite(t)?n(parseInt(t,10)):n(t,r))},this.applyTimezone=function(e){var n=i.timezone;return e&&n&&(e.tz?e=e.tz(n):o.warn("angular-moment: timezone specified but moment.tz() is undefined. Did you forget to include moment-timezone.js?")),e}}]).filter("amCalendar",["moment","amMoment",function(e,n){return function(t,o){if("undefined"==typeof t||null===t)return"";t=n.preprocessDate(t,o);var i=e(t);return i.isValid()?n.applyTimezone(i).calendar():""}}]).filter("amDateFormat",["moment","amMoment",function(e,n){return function(t,o,i){if("undefined"==typeof t||null===t)return"";t=n.preprocessDate(t,i);var a=e(t);return a.isValid()?n.applyTimezone(a).format(o):""}}]).filter("amDurationFormat",["moment",function(e){return function(n,t,o){return"undefined"==typeof n||null===n?"":e.duration(n,t).humanize(o)}}])}"function"==typeof define&&define.amd?define("angular-moment",["angular","moment"],e):e(angular,window.moment)}();
